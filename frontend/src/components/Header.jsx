...
const Header = () => {
  ...
  const estiloLink = (ruta) => ({
    color: esRutaActiva(ruta) ? colores.naranja : "rgba(255,255,255,0.72)",
            ...
            >
              <li className="nav-item">
                <Link
                  ...
                  style={estiloLink("/")}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = colores.naranja)
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.color = esRutaActiva("/")
                      ? colores.naranja
              ...
              <li className="nav-item">
                <Link
                  to="/torneos"
                  onClick={cerrarMenu}
                  style={estiloLink("/torneos")}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = colores.naranja)
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.color = esRutaActiva("/torneos")
                      ? colores.naranja
                      : "rgba(255,255,255,0.72)")
                  }
                >
              ...
              <li className="nav-item">
                <Link
                  to="/categorias"
                  onClick={cerrarMenu}
                  style={estiloLink("/categorias")}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = colores.naranja)
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.color = esRutaActiva("/categorias")
                      ? colores.naranja
                      : "rgba(255,255,255,0.72)")
                  }
                >
              ...
              <li className="nav-item">
                <Link
                  to="/anuncios"
                  onClick={cerrarMenu}
                  style={estiloLink("/anuncios")}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = colores.naranja)
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.color = esRutaActiva("/anuncios")
                      ? colores.naranja
                      : "rgba(255,255,255,0.72)")
                  }
                >
