                ...
                {showHelp && (
                    ...
                    >
                        <div className="bg-white p-4 rounded shadow" style={{ maxWidth: "500px" }}>
                            ...
                            <p>Desde esta sección podés administrar las sedes donde se disputarán los partidos.</p>
                            <p>
                                Utilizá el botón <strong className="text-primary"> Nueva sede</strong> para registrar
                                una nueva ubicación y el botón <strong className="text-warning"> Editar</strong> para modificar sus datos.
                            </p>
                        </div>
                    </div>
                )}
