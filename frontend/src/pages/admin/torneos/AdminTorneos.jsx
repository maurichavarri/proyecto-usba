                                                ...
                                                <tr key={torneo.id}>
                                                    ...
                                                    <td>
                                                        {new Date() <= new Date(torneo.fecha_cierre_inscripcion) ? (
                                                            <span className="badge bg-success">Abiertas</span>
                                                        ) : (
                                                            <span className="badge bg-danger">Cerradas</span>
                                                        )}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div className="d-flex gap-2">
                                                            ...
                                                            <button
                                                                className={torneo.estado === "activo" ? "btn btn-danger btn-sm" : "btn btn-success btn-sm"}
                                                                onClick={() => cambiarEstado(torneo.id)}
                                                            >
                                                                {torneo.estado === "activo" ? "Archivar" : "Activar"}
                                                            </button>
                                                        </div>
                                                    </td>
                                                </tr>
