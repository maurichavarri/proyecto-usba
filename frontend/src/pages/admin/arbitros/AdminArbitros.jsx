        ...
        <div className="container mt-5 mb-5">
            <div className="col-lg-10 mx-auto">
                ...
                <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <Link to="/panel/admin/arbitros/crear" className="btn btn-primary">
                        Nuevo árbitro
                    </Link>
                </div>
                                                ...
                                                arbitrosFiltrados.length > 0 ? (
                                                    arbitrosFiltrados.map((arbitro) => (
                                                        <tr key={arbitro.id}>
                                                            ...
                                                            <td>{arbitro.usuario?.correo || "-"}</td>
                                                            <td>
                                                                <Link to={`/panel/admin/arbitros/editar/${arbitro.id}`} className="btn btn-primary btn-sm">
                                                                    Editar
                                                                </Link>
                                                            </td>
                                                        </tr>
...
=======
        <div className="container mt-4 mb-5">
            ...
            <div className="d-flex align-items-center mb-2">
                <h2 className="me-2">Gestión de Árbitros</h2>
                <span
            ...
            <nav className="mb-3" style={{ fontSize: "0.9rem" }}>
                ...
                {" > "}
                <span className="text-muted">Árbitros</span>
            </nav>
            ...
            <div className="card shadow-sm">
                <div className="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                    <strong>Listado de árbitros</strong>
                    <input
                        type="text"
                        className="form-control w-auto"
                        placeholder="Buscar..."
                ...
                {showHelp && (
                    ...
                    >
                        <div className="bg-white p-4 rounded shadow" style={{ maxWidth: "500px" }}>
                            ...
                            <p>Desde aquí podés gestionar los árbitros del sistema.</p>
                            <p>Podrás registrar nuevos árbitros, modificar sus datos y posteriormente asignarlos a partidos dentro de los distintos torneos.</p>
                        </div>
                    </div>
                )}
            </div>
